...
window1 = {
            'start'    : '2015-09-16 19:50:00',  # Time is UTC
            'end'      : '2015-09-25 22:00:00',
          }
...
molecule = {
             ...
             'filter'          : 'w',            # The generic filter name
             # Optional fields. Defaults are as below.
             'type'            : 'EXPOSE',       # The type of the molecule
             'instrument_name' : '0M8-SCICAM-SBIG',       # This resolves to the main science camera on the scheduled resource
...
ur = UserRequest(group_id='112233445')
ur.add_request(req)
ur.operator = 'single'
