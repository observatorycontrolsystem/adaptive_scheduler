...
# adaptive clustering based on priority
#in  1000  runs, mean number of reservations scheduled was  38  and  36
#.
#----------------------------------------------------------------------
#Ran 2 tests in 294.429s
#
#OK

# adaptive clustering based on duration
#in  1000  runs, mean number of reservations scheduled was  45  and  42
#.
#----------------------------------------------------------------------
#Ran 2 tests in 310.239s
