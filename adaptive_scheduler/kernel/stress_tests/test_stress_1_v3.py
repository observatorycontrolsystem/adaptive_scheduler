...
class TestStress_1(object):
    ...
    def test_run_1(self, seed=None):
        ...
        fs = FullScheduler_v3(cr_list, gpw, [])
        s = fs.schedule_all()
...
# adaptive clustering by duration
# dasgoat:kernel slampoud$ nosetests stress_tests/test_stress_1_v3.py 
# in  1000  runs, mean duration was  5.50195  and mean number of reservations scheduled was  43
# .
# ----------------------------------------------------------------------
# Ran 2 tests in 412.667s
