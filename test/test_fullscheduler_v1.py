...
class TestFullScheduler_v1(object):
    ...
    def setup(self):
        s1 = [Timepoint(1, 'start', 'foo'),
              ...
              Timepoint(2, 'start', 'bar'),
              Timepoint(4, 'end', 'bar')] # --2--4
        # s2 == s1 == s3 == s4 == s5
        s2 = [Timepoint(1, 'start', 'foo'),
              Timepoint(2, 'end', 'foo'), # 1-2
              Timepoint(2, 'start', 'bar'),
              Timepoint(4, 'end', 'bar')] # --2--4
        s3 = [Timepoint(1, 'start', 'foo'),
              ...
              Timepoint(2, 'start', 'bar'),
              Timepoint(4, 'end', 'bar')] # --2--4
        s4 = [Timepoint(1, 'start', 'foo'),
              Timepoint(2, 'end', 'foo'), # 1-2
              Timepoint(2, 'start', 'bar'),
              Timepoint(4, 'end', 'bar')] # --2--4
        s5 = [Timepoint(1, 'start', 'foo'),
              Timepoint(2, 'end', 'foo'), # 1-2
              Timepoint(2, 'start', 'bar'),
              Timepoint(4, 'end', 'bar')] # --2--4
        ...
        self.r2 = Reservation_v2(2, 2, s2)
        self.r3 = Reservation_v2(1, 1, s3)
        self.r4 = Reservation_v2(1, 1, s4)
        self.r5 = Reservation_v2(2, 2, s5)

        self.cr1 = CompoundReservation_v2([self.r1])
        self.cr2 = CompoundReservation_v2([self.r3, self.r2], 'and')
#        self.cr3 = CompoundReservation_v2([self.r4], 'nof', 2)
    ...
    def test_convert_compound_to_simple(self):
        ...
        assert_equal(self.fs1.constraints[0][0], self.r3)
